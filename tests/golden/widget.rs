...
use eaglemode_rs::emCore::emPanelTree::{PanelTree, ViewConditionType};
...
use eaglemode_rs::emCore::emErrorPanel::emErrorPanel;

use eaglemode_rs::emCore::emFilePanel::emFilePanel;

use eaglemode_rs::emCore::emFileSelectionBox::emFileSelectionBox;

use eaglemode_rs::emCore::emLabel::emLabel;

use eaglemode_rs::emCore::emListBox::emListBox;
...
fn widget_colorfield() {
    ...
    cf.SetCaption("Color");
    cf.SetColor(eaglemode_rs::emCore::emColor::emColor::rgba(255, 0, 0, 255));
...
fn colorfield_expanded() {
    ...
    cf.SetColor(eaglemode_rs::emCore::emColor::emColor::rgba(0xBB, 0x22, 0x22, 0xFF));
...
fn listbox_expanded() {
    ...
    let mut lb = emListBox::new(look);
    lb.SetCaption("Items");
    lb.SetSelectionType(eaglemode_rs::emCore::emListBox::SelectionMode::Multi);
    lb.set_items(
...
fn golden_widget_colorfield_alpha_zero() {
    ...
    let mut cf = emColorField::new(look);
    cf.SetCaption("Color");
    cf.SetColor(eaglemode_rs::emCore::emColor::emColor::rgba(255, 0, 0, 0));
...
fn golden_widget_colorfield_alpha_near() {
    ...
    let mut cf = emColorField::new(look);
    cf.SetCaption("Color");
    cf.SetColor(eaglemode_rs::emCore::emColor::emColor::rgba(255, 0, 0, 1));
