...
fn assert_parallel_identical(
    ...
    let pool_1 = eaglemode_rs::emCore::emRenderThreadPool::emRenderThreadPool::new(1);
    ...
    let pool_n = eaglemode_rs::emCore::emRenderThreadPool::emRenderThreadPool::new(thread_count);
...
fn parallel_benchmark() {
    ...
    let multi_elapsed = {
        ...
        let pool = eaglemode_rs::emCore::emRenderThreadPool::emRenderThreadPool::new(4);
        let mut comp = SoftwareCompositor::new(800, 600);
        let start = std::time::Instant::now();
        for _ in 0..iterations {
