...
use eaglemode_rs::emCore::emRec::RecStruct;
use eaglemode_rs::emCore::emContext::emContext;

use eaglemode_rs::emCore::emFileModel::{emFileModel, FileModelOps, FileState};

use eaglemode_rs::emCore::emRec::RecError;

use eaglemode_rs::emCore::emRecFileModel::emRecFileModel;

use eaglemode_rs::emCore::emRecRecord::Record;

use eaglemode_rs::emCore::emRes::ResourceCache;

use eaglemode_rs::emCore::emVarModel::WatchedVar;
...
fn write_test_rec(path: &std::path::Path, name: &str, count: i32) {
    ...
    let content = eaglemode_rs::emCore::emRec::write_rec(&r);
...
fn make_signal() -> eaglemode_rs::emCore::emSignal::SignalId {
