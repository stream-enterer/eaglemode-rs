...
fn checkbutton_enter_key_toggles() {
    ...
    h.press_key(eaglemode_rs::emCore::emInput::InputKey::Enter);
    assert!(
        !cb_ref.borrow().IsChecked(),
...
fn checkbutton_shift_click_accepted() {
    ...
    h.input_state.press(eaglemode_rs::emCore::emInput::InputKey::Shift);
    h.click(400.0, 300.0);
    h.input_state.release(eaglemode_rs::emCore::emInput::InputKey::Shift);
...
fn checkbutton_ctrl_click_rejected() {
    ...
    h.input_state.press(eaglemode_rs::emCore::emInput::InputKey::Ctrl);
    h.click(400.0, 300.0);
    h.input_state.release(eaglemode_rs::emCore::emInput::InputKey::Ctrl);
...
fn checkbutton_alt_click_rejected() {
    ...
    h.input_state.press(eaglemode_rs::emCore::emInput::InputKey::Alt);
    h.click(400.0, 300.0);
    h.input_state.release(eaglemode_rs::emCore::emInput::InputKey::Alt);
...
fn checkbutton_meta_click_rejected() {
    ...
    h.input_state.press(eaglemode_rs::emCore::emInput::InputKey::Meta);
    h.click(400.0, 300.0);
    h.input_state.release(eaglemode_rs::emCore::emInput::InputKey::Meta);
