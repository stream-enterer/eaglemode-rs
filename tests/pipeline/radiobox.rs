...
use eaglemode_rs::emCore::emRadioButton::RadioGroup;
...
struct RadioBoxHarness {
    ...
    group: Rc<RefCell<eaglemode_rs::emCore::emRadioButton::RadioGroup>>,
    panels: [eaglemode_rs::emCore::emPanelTree::PanelId; 3],
